...
/**
 * Expected simple match option expression.
 */
@Getter
@Setter
public class ExpectedSimpleMatchOptionExpression extends AbstractExpectedSQLSegment implements ExpectedExpressionSegment {
